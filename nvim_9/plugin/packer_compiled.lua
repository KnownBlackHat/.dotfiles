...
_G.packer_plugins = {
  ...
  ["emmet-vim"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/emmet-vim",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
  ...
  ["vim-multiple-cursors"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/vim-multiple-cursors",
